...
> **Status: unaudited. Not deployed.** All four programs build to BPF and pass 112 tests
...
**47 runtime tests** ([`tests/integration/`](./tests/integration)) execute the real BPF
...
Of 52 documented invariants, **44 are verified, 3 partial, 5 untested** — tracked row by
